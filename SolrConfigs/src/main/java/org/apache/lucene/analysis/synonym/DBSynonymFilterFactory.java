...
public class DBSynonymFilterFactory extends TokenFilterFactory implements
		ResourceLoaderAware
{

	private final TokenFilterFactory	delegator;

	public DBSynonymFilterFactory(Map<String, String> args)
	{
		super(args);
		assureMatchVersion();
		delegator = new DBSlowSynonymFilterFactory(new HashMap<String, String>(
				getOriginalArgs()));
	}
