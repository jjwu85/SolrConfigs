 ...
 * 
 */
public class AmbiguityDicLoderListener implements ZKStartListener
{

	private final Logger	LOG	= LoggerFactory
										.getLogger(AmbiguityDicLoderListener.class);

	private final String	nodePath;

	public AmbiguityDicLoderListener(String nodePath)
	{
